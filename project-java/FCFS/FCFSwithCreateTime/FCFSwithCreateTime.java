...
public class FCFSwithCreateTime 
{
    public static void main(String[] args)
    {
        ...
        for(i=0;i<5;i++)
        {
            ...
            System.out.println("id:"+P[i].ProcessID+"  CreateTime:"+P[i].CreateTime+"  ReaminTime:"+P[i].Remaintime);
        ...
        while(true)
        {
            ...
            if(CurrentProcess!=null)
            {
                System.out.println("CurrentProcess: id:"+CurrentProcess.ProcessID+"  RemainTime: "+CurrentProcess.Remaintime+"  ServedTime:"+CurrentProcess.ServedTime+" WaitTime:"+CurrentProcess.WaitTime);
